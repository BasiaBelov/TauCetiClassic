/obj/effect/proc_holder/changeling/augmented_eyesight
	...
	desc = "Создает тепловые рецепторы в наших глазах и значительно повышает светочувствительность."
	helptext = "Дает нам ночное зрение. Он может быть включен или выключен."
	chemical_cost = 0
	genomecost = 3
