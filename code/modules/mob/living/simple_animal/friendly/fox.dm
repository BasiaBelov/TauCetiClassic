...
/mob/living/simple_animal/fox
	name = "fox"
	desc = "Это лиса. Интересно, что он говорит?"
	icon_state = "fox"
	icon_living = "fox"
	icon_dead = "fox_dead"
	speak = list("Акь-акь","Акь-акь-ауууу","Гекь","Аууу","Тюфь")
	speak_emote = list("geckers", "barks")
	emote_hear = list("чавкает","лает")
	emote_see = list("качает головой", "виляет хвостом")
	speak_chance = 1
	turns_per_move = 5
	see_in_dark = 6
	w_class = SIZE_BIG
